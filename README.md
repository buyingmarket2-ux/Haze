...
To create an instance of GameTFM with your own domain, create an `A` record pointing to **198.251.70.32**.

For a one-click static deployment for hosting services (Vercel, Netlify, Render, etc.), see
[GameTFM-deploy](https://github.com/smartfoloo/GameTFM-deploy).
